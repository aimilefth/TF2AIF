...
This module defines the AgxServer class, which inherits from the BaseExperimentServer class defined in the experiment_server module.
The AgxServer class represents an AGX-based implementation of the experiment server, optimized for running ONNX Runtime models.

Overview:
- The AgxServer class is responsible for initializing the ONNX Runtime environment, loading the model, and executing inference experiments.
...
Classes:
- AgxServer: Inherits from BaseExperimentServer and implements AGX-specific initialization and inference methods.
...
class AgxServer(experiment_server.BaseExperimentServer):
    """
    AGX-specific server implementation for running ONNX Runtime models.
    Inherits from BaseExperimentServer and implements AGX-specific initialization and inference methods.
    """
    def __init__(self, logger):
        """Initialize the AgxServer instance, set up the logger, initialize the kernel, and perform a warm-up run."""
