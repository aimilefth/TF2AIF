...
This module defines the AgxTfServer class, which inherits from the BaseExperimentServer class defined in the experiment_server module. The AgxTfServer class represents an AGX-based implementation of the experiment server using native Tensorflow.
...
class AgxTfServer(experiment_server.BaseExperimentServer):
    ...
    def init_kernel(self):
        """Initialize one time platform-specific server operations. Loads the Tensorflow model, and configures execution providers."""
        print('init_kernel')
