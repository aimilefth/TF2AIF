...
This module defines the ArmTfServer class, which inherits from the BaseExperimentServer class defined in the experiment_server module. The ArmTfServer class represents an ARM-based implementation of the experiment server using native Tensorflow.
...
class ArmTfServer(experiment_server.BaseExperimentServer):
    def __init__(self, logger):
        ...
        self.model = None
        # ARM_TF specific configuration setup
